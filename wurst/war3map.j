...
function CreateUnitsForPlayer0 takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'earc', -5258.0, -65.0, 243.234 )
    set u = CreateUnit( p, 'earc', 5381.8, -57.4, 125.039 )
    set u = CreateUnit( p, 'earc', 5493.7, 388.5, 45.375 )
    set u = CreateUnit( p, 'earc', 5314.2, 336.8, 244.970 )
    set u = CreateUnit( p, 'earc', 5196.1, 251.8, 273.744 )
    set u = CreateUnit( p, 'earc', 5131.9, 188.2, 35.047 )
    set u = CreateUnit( p, 'earc', 5092.1, 100.9, 248.991 )
    set u = CreateUnit( p, 'earc', 5068.0, 13.6, 137.685 )
    set u = CreateUnit( p, 'earc', 5068.3, -106.7, 117.173 )
    set u = CreateUnit( p, 'earc', 5074.6, -238.7, 90.113 )
    set u = CreateUnit( p, 'earc', 5079.0, -328.8, 287.587 )
    set u = CreateUnit( p, 'earc', 5113.6, -454.2, 41.661 )
    set u = CreateUnit( p, 'earc', 5138.1, -527.2, 272.953 )
    set u = CreateUnit( p, 'e000', 4932.8, 36.4, 41.299 )
endfunction
